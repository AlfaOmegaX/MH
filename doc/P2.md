...
Los tiempos entre todos son casi los mismos dado que la condición de parada es la misma, e igual pasa con la tasa de acierto, de reducción y de agregado, como se ve en las tablas. Obviamente tarda mucho más en Texture ya que tiene muchísimos datos y cuesta más aplicar la función objetivo.
